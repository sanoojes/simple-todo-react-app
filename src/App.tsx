    ...
    return (
        <>
            <main className="flex-center h-screen w-screen bg-[url('/bg.webp')] bg-cover bg-center m-0 font-semibold font-sans">
                <div className="w-screen h-screen absolute bg-neutral-950 bg-opacity-30"></div>
                <button
                    type="button"
                ...
                <div className="flex-center flex-col gap-4 w-11/12 bg-neutral-950 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-15 border border-gray-100 px-8 py-10 max-w-screen-sm drop-shadow-2xl shadow-2xl shadow-neutral-950 backdrop-brightness-125 saturate-100">
